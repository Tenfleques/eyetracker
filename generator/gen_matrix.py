...
class gen_MATRIX(BoxLayout):
    ...
    def __init__(self, work_folder, VideoSettings, VideoSetWidget, font, **kwargs):
        ...
        s1 = Parameter(key = 'MWidth', label = 'Width:', startval = 10, halign_in = 'left', valign_in = 'bottom', orientation = 'vertical')
        s2 = Parameter(key = 'MHeigh', label = 'Height:', startval = 10, halign_in = 'left', valign_in = 'bottom',  orientation = 'vertical')
        s3 = Parameter(key = 'MFontSz', label = 'Font size:', startval = 50, halign_in = 'left', valign_in = 'bottom',  orientation = 'vertical')
        s4 = Parameter(key = 'MLetDist', label = 'Letter spacing:', startval = 20, halign_in = 'left', valign_in = 'bottom',  orientation = 'vertical')
        ...
        self.word = TextInput(text = 'Устал', size_hint = [1.0, 0.5], multiline = False)
        ...
        s5 = Parameter(key = 'MWidthPos', label = 'width wise:', startval = 3, halign_in = 'left', valign_in = 'bottom',  orientation = 'vertical')
        s6 = Parameter(key = 'MHeighPos', label = 'height wise:', startval = 3, halign_in = 'left', valign_in = 'bottom',  orientation = 'vertical')
    ...
    def press_select(self, instance):
        ...
        self.image_lay.add_widget(Image(source = PATH+im_out))
    ...
    def press_generation(self, instance):
        ...
        for word in word_list:
            ...
            file_name = self.work_folder+'output/'+'_'.join([word, str(X_size), str(Y_size), str(X_start), str(Y_start), self.orientation])
